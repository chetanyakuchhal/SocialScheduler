...
export const schedulePost = asyncHandler(async (req: AuthRequest, res: Response): Promise<void> => {
        ...
        let mediaUrl: string | undefined = sanitizeString(req.body.mediaUrl, 1000) || undefined;
        let mediaType: "image" | "video" | undefined = ["image", "video"].includes(req.body.mediaType) ? req.body.mediaType : undefined;
