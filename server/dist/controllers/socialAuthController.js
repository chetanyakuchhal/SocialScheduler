...
export const syncAccounts = async (req, res) => {
    try {
        ...
        const supportedPlatforms = ["twitter", "linkedin", "facebook", "instagram", "facebook_page", "linkedin_page", "instagram_business"];
        ...
        for (const zAccount of zernioAccounts) {
            ...
            const account = await Account.findOneAndUpdate({ zernioAccountId: zid, user: req.user._id }, {
                user: req.user._id,
